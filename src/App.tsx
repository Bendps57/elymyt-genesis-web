...
import { Helmet, HelmetProvider } from "react-helmet-async"; // Updated import from react-helmet to react-helmet-async
  ...
  <QueryClientProvider client={queryClient}>
    <HelmetProvider>
      <Helmet>
        ...
        <meta property="og:site_name" content="eLimyt - Agence Web" />
